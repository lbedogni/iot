...
In the same figure we also report the time of the last update for all the found streams.\st{The diagram reports also the last update date for each stream.}
